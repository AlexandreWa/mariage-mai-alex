...
## Pour réutiliser à son tour

1. Clonez ce dépôt sur votre ordinateur :
  ```bash
   $ git clone https://github.com/alexandrewa/mariage-mai-alex.git
  ```
2. Accédez au dossier du projet :
  ```bash
   $ cd mariage-mai-alex
  ```
3. Installez les dépendances (si vous souhaitez modifier le code) :
  ```bash
   $ npm install
  ```
4. Compilez les fichiers SASS et minifiez le JavaScript (si nécessaire) :
  ```bash
   $ gulp
  ```
5. Ouvrez le fichier `index.html` dans votre navigateur pour visualiser le site.
...
Si vous souhaitez contribuer à ce projet ou l’adapter pour votre propre mariage, n’hésitez pas à créer une **pull request** ou à nous contacter pour toute question.
